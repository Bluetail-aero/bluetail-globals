...
const path = require('path');
   ...
   */
 exports.containsIllegalCharacters = function (someString) {
   ...
   */
  exports.isSupportedFileExtension = function (filename, supportedExtentions = SUPPORTED_EXTENSIONS) {
   ...
   * @returns {boolean} - True if the file has a supported extension, false otherwise. If filename is undefined, null, or not a string, returns false.
   */
  exports.isSupportedMimeType = function (mimeType, supportedMimetypes = SUPPORTED_MIME_TYPES) {
